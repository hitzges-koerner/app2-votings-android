...
import kotlinx.android.synthetic.main.fragment_voting_create_cornfirmation.*
...
class VotingCreateConfirmationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_voting_create_cornfirmation, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        buttonCardViewVoingCreateConfirmation.materialCardView.setOnClickListener {
